...
const Search = () => {
  ...
  return (
    <>
      ...
      <div className="relative container -mt-20 lg:-mt-48 bg-white dark:bg-[#051A36] mx-auto py-20 space-y-10 border border-gray-100 dark:border-[#092c59] rounded-xl w-1/2 shadow-2xl my-10 flex flex-col justify-center items-center">
        <div className="text-xl">جستجو در یوبیتکس بلاگ</div>
